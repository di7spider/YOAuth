<?
  /* 
      .:: Yandex APP Auth ::. 
        ...
        Info :  Класс предназначен для получения "Yandex OAuth Token", 
  ...
  class YAPPAuth
    {
        ...
        */
		static protected function _getCookie()
		 {
			$arParams = self::$_PARAMS;

			if(is_array($arParams)){

                $sessCookie = self::$_PARAMS['SESSIONS']['COOKIE'];
		...
		static protected function _getCode()
		 {
			...
			if(is_array($arParams)){
                ...
                $sessCode = self::$_PARAMS['SESSIONS']['CODE'];
		...
		static protected function _getToken()
		 {
            ...
            if(is_array($arParams)){
                ...
                $sessToken = self::$_PARAMS['SESSIONS']['TOKEN'];
        ...
        static public function setParams($params = false, $type = false)
         {
            if(is_array($params)){
                ...
                if(array_key_exists($type, self::$_PARAMS)){
